...
export default function DailyRFISheet() {
    ...
    function openRfiDiscussion(rfi) {
        const targetDate = rfi.carryoverTo || rfi.originalFiledDate || rfi.filedDate;
            ...
            <main className="rfi-sheet-page">
                ...
                <div className="sheet-section" style={{ overflow: 'hidden' }}>
                    <div className="section-header" style={{ gap: '0.8rem', flexWrap: 'wrap' }}>
                        <h2 style={{ margin: 0 }}>📍 My RFI Status Tracker</h2>
                                        ...
                                        <tr key={`tracker_${rfi.id}`}>
                                            ...
                                            <td data-label="Actions">
                                                <div style={{ display: 'flex', gap: '0.4rem', alignItems: 'center', flexWrap: 'wrap' }}>
                                                    <button className="btn btn-sm btn-ghost" onClick={() => openRfiDiscussion(rfi)} title="Open Discussion">
                                                    ...
                                                    {rfi.status === RFI_STATUS.REJECTED && (
                                                        <button
                                                            ...
                                                            style={{ backgroundColor: 'var(--clr-brand-primary)', color: '#fff', border: '1px solid var(--clr-brand-primary)' }}
